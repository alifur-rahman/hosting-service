        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                    <a href="index.php" class="d-inline-block mb-3 al_footerLogo"><img
                            src="assets/images/brand/logo-hostinginindia.webp" alt="img"></a>
                    <p class="mb-4 op-8 fw-light">
                        Let’s get this converstaion started. Tell us a bit about yourself, and we’ll get in touch as
                        soon as we can.
                    </p>
                    <ul class="list-unstyled mb-0">
                        <li class="list-item mb-2"><a href="tel:+91 9560607752" class="footer-link"><i
                                    class="bi bi-telephone me-3 tx-18"></i>+91 9560607752</a></li>
                        <li class="list-item mb-2"><a href="mailto: support@hostinginindia.com" class="footer-link"><i
                                    class="bi bi-envelope-plus me-3 tx-18"></i>support@hostinginindia.com</a></li>
                        <li class="list-item"><a href="javascript:void(0);" class="footer-link"><i
                                    class="bi bi-geo-alt me-3 tx-18"></i>Gurgaon Haryana, India - 122009</a></li>
                    </ul>
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled footer-icon">
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Register Domain
                                Name</a></li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">View Domain
                                Pricing</a></li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Premium Domains</a>
                        </li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Transfer Your
                                Domain</a></li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Bulk Domain
                                Transfer</a></li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Free With Every
                                Domain</a></li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Name
                                Suggestion</a></li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Whois Lookup</a>
                        </li>
                        <li class="list-item"><a href="javascript:void(0);" class="footer-link">View Promos</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                    <h4 class="text-white">Hosting & Products</h4>
                    <ul class="list-unstyled footer-icon">
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Linux
                                Hosting</a></li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Windows
                                Hosting</a></li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">WordPress
                                Hosting</a></li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Dedicated
                                Servers</a></li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Reseller
                                Hosting</a></li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Cloud Hosting</a>
                        </li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">SSL
                                Certificates</a></li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">SiteLock</a></li>
                        <li class="list-item"><a href="javascript:void(0);" class="footer-link">Codeguard</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled footer-icon">
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Our Blog</a></li>
                        <li class="list-item mb-2"><a href="contact.php" class="footer-link">Contact Support</a></li>
                        <li class="list-item mb-2"><a href="contact.php" class="footer-link">Report Abuse</a></li>
                        <li class="list-item mb-2"><a href="javascript:void(0);" class="footer-link">Affiliate</a></li>
                        <li class="list-item mb-2"><a href=javascript:void(0);" class="footer-link">Cancellation &
                                Refund Policy</a></li>
                        <li class="list-item"><a href="javascript:void(0);" class="footer-link">Payment Options</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="d-md-flex align-items-center">
                        ...
                        <div class="mt-3 mt-md-0">
                            ...
                            <a href="javascript:void(0);" class="text-white"><i class="far fa-plus me-1"></i>And
                                more</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <ul class="list-unstyled d-sm-flex mb-0 justify-content-lg-end mt-3 mt-lg-0 ">
                        ...
                        <li class="list-item"><a href="javascript:void(0);" class="footer-link px-3 op-8">Legal</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="py-3 border-top border-white-2 text-center">
        <div class="container">
            <span class="tx-14 op-8">
                Copyright &#169;
                <span id="year"></span>
                <a href="index.php" class="text-white">HostingInIndia.</a>
                All Rights Reserved
            </span>
        </div>
    </div>
