    ...
    <aside class="app-sidebar" id="sidebar">
        ...
        <div class="app-toggle-header">
            ...
            <a href="index.php" class="brand-main">
                <img src="assets/images/brand/logo-hostinginindia.webp" alt="img" class="desktop-logo logo-dark">
                <img src="assets/images/brand/logo-hostinginindia.webp" alt="img" class="desktop-logo logo-color">
            </a>
        </div>
        ...
        <div class="main-sidebar container" id="sidebar-scroll">
            ...
            <nav class="main-menu-container nav nav-pills sub-open">
                <ul class="main-menu">
                    ...
                    <li class="slide has-sub">
                        <a href="javascript:void(0);" class="side-menu__item">
                            <span class="side-menu__label">VPS & Servers</span>
                            <i class="fe fe-chevron-down side-menu__angle"></i>
                        </a>
                        <ul class="slide-menu child1 ega-slide-menu-twofr">
                                    ...
                                    <ul>
                                        <li>
                                            <p class="mb-3 d-flex align-items-center menu-label">
                                                ...
                                                <span class="tx-14 tx-primary">Virtual Private Server</span>
                                            </p>
                                        </li>
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">
                                                <div class="d-lg-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h6 class="d-block mb-1">Linux Cloud VPS India</h6>
                                                        <span class="tx-default tx-14">Book here</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">
                                                <div class="d-lg-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h6 class="d-block mb-1">Linux Cloud VPS USA/EU</h6>
                                                        <span class="tx-default tx-14">Book here</span>
                                                    </div>
                                                </div>
                                            </a>
                                        ...
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">
                                                <div class="d-lg-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h6 class="d-block mb-1">Windows Cloud VPS India</h6>
                                                        <span class="tx-default tx-14">Book here</span>
                                                    </div>
                                                </div>
                                            </a>
                                        ...
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">
                                                <div class="d-lg-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h6 class="d-block mb-1">Windows Cloud VPS USA/EU</h6>
                                                        <span class="tx-default tx-14">Book here</span>
                                                    </div>
                                                </div>
                                            </a>
                                    ...
                                    <ul>
                                        <li>
                                            <p class="mb-3 d-flex align-items-center menu-label">
                                                ...
                                                <span class="tx-14 tx-primary">Dedicated Servers</span>
                                            </p>
                                        </li>
                                        ...
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">
                                                <div class="d-lg-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h6 class="d-block mb-1">Dedicated Servers India</h6>
                                                        <span class="tx-default tx-14">Book here</span>
                                                    </div>
                                                </div>
                                            </a>
                                        ...
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">
                                                <div class="d-lg-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h6 class="d-block mb-1">Dedicated Servers USA/EU</h6>
                                                        <span class="tx-default tx-14">Book here</span>
                                                    </div>
                                                </div>
                                            </a>
                                            ...
                                            <a href="javascript:void(0);" class="side-menu__item">
                                                <div class="d-lg-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <span class="tx-default tx-14">Pre-register to get the name of
                                                            your choice</span>
                                                    </div>
                                                </div>
                                            </a>
                                            ...
                                            <a href="javascript:void(0);" class="side-menu__item">
                                                <div class="d-lg-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <span class="tx-default tx-14">Register catchy, popular Domain
                                                            Names</span>
                                                    </div>
                                                </div>
                                            </a>
                    ...
                    <li class="slide has-sub">
                        <a href="javascript:void(0);" class="side-menu__item">
                            <span class="side-menu__label">SSL & Security</span>
                            <i class="fe fe-chevron-down side-menu__angle"></i>
                        </a>
                                                ...
                                                <div class="d-lg-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h6 class="d-block mb-1">Codegaurd Website
                                                            Backup</h6>
                                                        <span class="tx-default tx-14">Your data is preciuos. Secure
                                                            your
                    ...
                    <li class="slide has-sub">
                        <a href="javascript:void(0);" class="side-menu__item">
                            <span class="side-menu__label">Website Design</span>
                            <i class="fe fe-chevron-down side-menu__angle"></i>
                                            ...
                                            <a href="javascript:void(0);" class="side-menu__item">
                                                <div class="d-lg-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <span class="tx-default tx-14">Download plugins and scripts to
                                                            add
                                            ...
                                            <a href="javascript:void(0);" class="side-menu__item">
                                                <div class="d-lg-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <span class="tx-default tx-14">Choose a customizable template
                                                            and
                ...
                <div class="d-xl-flex d-lg-none d-grid gap-2 text-center">
                    <a href="https://www.client.hostinginindia.com/register.php"
                        class="btn btn-secondary min-w-fit-content">Register</a>
                    <a href="https://www.client.hostinginindia.com/index.php?rp=/login"
                        class="btn btn-outline-light login-btn min-w-fit-content">Login</a>
                </div>
