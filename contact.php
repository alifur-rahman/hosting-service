                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-md-12 text-center">
                                <div class="">
                                    <p class="mb-3 content-1 h5 text-white">Contact <span class="tx-info-dark">Us</span>
                                    </p>
                                    <p class="mb-0 tx-28">Easily accessible customer service is crucial in today's
                                        24-hour</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-xl-3 col-md-6 col-lg-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    <span
                                                        class="avatar avatar-lg bg-secondary-gradient text-white tx-24 br-style"><i
                                                            class="bi bi-geo-alt"></i></span>
                                                </div>
                                                <h5 class="mb-1">Contact Details</h5>
                                                <p class="mb-0">SHOP NO 1094P, OAHFEO FRAPPE Sector 46 Road, SG
                                                    Services, Sector 46 Gurugram, Haryana 122003</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-lg-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    <span
                                                        class="avatar avatar-lg bg-pink-gradient br-style text-white tx-24"><i
                                                            class="bi bi-telephone"></i></span>
                                                </div>
                                                <h5 class="mb-1">Phone</h5>
                                                <p class="mb-0">Mobile: +91 9560607752 (Timing: 10 AM - 6 PM)
                                                    Whatsapp No. :+91 9818652075 (Timing: 6 PM - 10 AM)
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-lg-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    <span
                                                        class="avatar avatar-lg bg-purple-gradient br-style text-white tx-24"><i
                                    ...
                                    <div class="col-xl-3 col-md-6 col-lg-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    <span
                                                        class="avatar avatar-lg bg-teal-gradient br-style text-white tx-24"><i
                                        ...
                                        <div class="col-lg-7">
                                            <div class="card feature-client-bg shadow-none">
                                                <img src="assets/images/patterns/9.png" alt="img"
                                                    class="patterns-9 sub-pattern-2 filter-invert op-1 z-index--1">
                                                    ...
                                                    <form class="form-horizontal" action="index.php">
                                                        ...
                                                        <div class="">
                                                            <a href="javascript:void(0)"
                                                                class="btn btn-secondary btn-lg bg-secondary-gradient">Send
                                                                Message</a>
                                                        </div>
                                                    </form>
                                                </div>
                                        ...
                                        <div class="col-lg-5">
                                            <div class="card bg-transparent shadow-none ">
                                                <div class="card-body pb-0">
                                                    ...
                                                    <p class="mb-4">Let’s get this converstaion started. Tell us a bit
                                                        about yourself, and we’ll get in touch as soon as we can. </p>
                                                    <ul class="list-unstyled">
                                                        <li class="list-item mb-4">
                                                            <div class="d-flex">
                                                                <span
                                                                    class="tx-primary tx-20 me-3 avatar bg-primary-01 rounded-circle my-auto"><i
                                                                        class="bi bi-geo-alt"></i></span>
                                                                <div>
                                                                    <h6 class="mb-0">
                                                                        <Address></Address>
                                                                    </h6>
                                                                    <p class="mb-0">SHOP NO 1094P, OAHFEO FRAPPE Sector
                                                                        46 Road, SG Services, Sector 46 Gurugram,
                                                                        Haryana 122003 </p>
                                                                </div>
                                                            </div>
                                                        </li>
                                            ...
                                            <div class="">
                                                <img src="assets/images/patterns/7.png" alt="img"
                                                    class="patterns-8 sub-pattern-3 z-index-0 op-1">
                                            </div>
                                        </div>
                                    </div>
                                </div>
