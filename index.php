        ...
        <div class="main-content app-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-7">
                            <div class="mb-5">
                                ...
                                <p class="content-2">Dedicated resources, full root access & easy scaling. It is the
                                    virtual private server you've been cravin'</p>
                            </div>
                            <a href="#domain" class="btn btn-lg  btn-secondary me-2 mb-2 mb-sm-0"><i
                                    class="bi bi-arrow-right me-2"></i>Get Started</a>
                            <a href="contact.php" class="btn btn-lg btn-white mb-2 mb-sm-0"><i
                        ...
                        <div class="col-lg-4">
                            <div class="card pricing-card border mb-lg-0">
                                <div class="card-body">
                                    ...
                                    <p class="mb-4">Magna dolore elitr ut et labore stet dolor tempor at ipsum, amet
                        ...
                        <div class="col-lg-4">
                            <div class="card pricing-card border mb-lg-0">
                                <div class="card-body">
                                    ...
                                    <p class="mb-4">Blanditiis praesentium voluptatum deleniti atque corrupti quos
                                        dolores rerum hic tenetur.</p>
                                    <a href="javascript:void(0);" class="btn btn-primary">Get Started Now</a>
                                </div>
                            </div>
                        </div>
            ...
            <section class="section overflow-hidden">
                ...
                <div class="container">
                    <div class="row">
                        <div class="heading-section">
                            <div class="heading-subtitle"><span class="tx-primary tx-16 fw-semibold">Services</span>
                            </div>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card border feature-card-15 mb-xl-0">
                                <div class="card-body text-center">
                                    ...
                                    <h5>Reliability</h5>
                                    <p class="mb-0">Justo aliquyam duo vero clita aliquyam vero eirmod stet amet.
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card border feature-card-15 mb-xl-0">
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-0">Sed ut perspiciatis unde omnis natus error sit voluptatem
                                        accusantium doloremque laudantium, totam rem aperiam nemo enim.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-sm-6">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 reveal">
                            ...
                            <p class="mb-4">
                                Create your website instantly, no coding/design skills required. Choose from over 100
                                themes or simply drag-and-drop to customize your design.
                            </p>
                            ...
                            <div class="card-body text-center">
                                ...
                                <form action="javascript:void(0);" class="form mb-4">
                                    <div class="form-group custom-form-group">
                                        ...
                                        <button
                                            class="custom-form-btn btn btn-lg btn-primary bg-primary-gradient border-0"
            ...
            <section class="section">
                ...
                <div class="container">
                    <div class="heading-section">
                        ...
                        <div class="heading-title">Free Add-Ons With Every <span class="tx-primary">Domain Name</span>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="card feature-card reveal">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0">Ut enim ad minima veniam, quis nostrum exercitationem corporis
                                        suscipit laboriosam, nisi ut aliquid commodi consequatur.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                            <div class="card feature-card reveal">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0">Nam libero tempore, nobis est eligendi optio cumque nihil impedit
                                        quo minus id quod maxime placeat facere possimus, omnis voluptas est.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
            ...
            <section class="section bg-pattern-2 bg-image2">
                <div class="container">
                    <div class="heading-section">
                        ...
                        <div class="heading-description text-white op-8">Est amet sit vero sanctus labore no sed ipsum
                            ipsum nonumy.</div>
                    </div>
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card text-center feature-card-16 mb-lg-0 secondary">
                                <div class="card-body">
                                    <svg class="feature-icon br-style1 secondary mb-3"
                                        xmlns="http://www.w3.org/2000/svg" height="60" width="60" viewBox="0 0 24 24">
                                        <path fill="#fcbf8e"
            ...
            <section class="section">
                <div class="container">
                    <div class="heading-section">
                        ...
                        <div class="heading-description">Est amet sit vero sanctus labore no sed ipsum ipsum nonumy.
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card mb-lg-0">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <h5><a href="javascript:void(0);" class="tx-color-default">Starting a Web Hosting
                                            Business</a></h5>
                                    <div class="tx-muted">To take a trivial example, which of us ever undertakes
                                        laborious physical exerciser , except to obtain some advantage from it...</div>
                        ...
                        <div class="col-lg-4">
                            <div class="card mb-lg-0">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <h5><a href="javascript:void(0);" class="tx-color-default">Email Hosting For Your
                                            Projects</a></h5>
                        ...
                        <div class="col-lg-4">
                            <div class="card mb-lg-0">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <h5><a href="javascript:void(0);" class="tx-color-default"> Cloud Hosting growing
                                            faster </a></h5>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-7">
                            ...
                            <p class="tx-20 fw-500">Call Us : <a href="tel:+91 9818 652075" class="text-white me-1">+91
                                    9818 652075</a> (Or) <a
                                    href="https://api.whatsapp.com/send/?phone=+919818652075&text=Hello%21&type=phone_number&app_absent=0;"
                                    class="text-white ms-1">Chat Now</a></p>
                            <a href="contact.php" class="btn btn-lg btn-secondary">Contact Now</a>
                        </div>
                        <div class="col-lg-5">
